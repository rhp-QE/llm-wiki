...
| "Obsidian", "图谱", "MOC", "可视化", "地图页" | Schema change or maintenance | `system/obsidian.md`, `wiki/home.md`, `wiki/maps/AGENTS.md` |
...
Use `wiki/home.md` and `wiki/maps/` for Obsidian navigation, MOC pages, and visual browsing.
